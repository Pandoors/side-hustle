...
function JobCard({ params, topElements, bottomElements  }: { params: offer, topElements?: JSX.Element[], bottomElements?: JSX.Element[] }) {
  const state = useStateProvider()

  return (
    <div className="job_card" onClick={()=>{
      state.setCurrentOffer(params.offerId)
    }}>
