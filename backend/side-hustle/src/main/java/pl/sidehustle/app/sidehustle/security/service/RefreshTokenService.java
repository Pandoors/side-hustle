...
import pl.sidehustle.app.sidehustle.security.repository.RefreshTokenRepository;


@Service
public class RefreshTokenService {
    @Value("${pl.sidehustle.jwtRefreshExpirationMs}")
    ...
    public RefreshToken createRefreshToken(Long userId) {
        ...
        refreshToken.setUser(userRepository.getUserById(userId));
    ...
    public int deleteByUserId(Long userId) {
        return refreshTokenRepository.deleteByUser(userRepository.getUserById(userId));
    }
}